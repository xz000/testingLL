...
> **状态（2026-09-13）**：英雄冲刺逐轴反弹**已做**；**弹体撞柱已按 `xv` 实现**：
> `skill::pillar_restitution(id)`：S008=`.75`（衰减反弹），S000/S004/S009/S014/S016/S018=`1`（满反弹），其余 `0`（被挡）。
> W098b 撞柱表面反射后再乘 `xv` + 对柱伤害；已入快照。
