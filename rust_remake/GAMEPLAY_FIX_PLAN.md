...
> **状态（2026-09-13）**：英雄冲刺逐轴反弹**已做**；**弹体撞柱已改为按 `xv` 技能集反弹**：
> `skill::pillar_bounce_for(id)` 对 S000/S004/S008/S009/S014/S016/S018 返回 true（W098b 撞柱表面反射 + 对柱伤害），
> 其余仍被挡下（对应 098c 默认 `xv=-1`）。待细：`xv` 的 `1` vs `.75`（S008）衰减差异未区分。
