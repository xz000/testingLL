...
| 槽 | 名称 | 原版机制 | 当前 Rust |
|----|------|----------|-----------|
| D2 | Fireball 回旋镖 | 直射火球但**持续向施法者加速回飞**（boomerang），撞墙反弹；撞人→爆炸推+伤 | ⚠ 现为"一次性直线命中"，无回飞/反弹 |
| D3 | Missile 追踪导弹 | 锁定**点击处最近**敌人，全速直追（velocity=dir*Speed），命中爆炸推+伤 | ⚠ 现锁定"自身最近"，与点击处不一致 |
| D4 | Fireball·香蕉 | **两条 ±45° 曲线飞行**香蕉弹（CCWTurn），撞人爆炸推+伤 | ❌ 未实现 |
