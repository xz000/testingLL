...
const EN: &[(&str, &str)] = &[
    ...
    ("音乐音量", "Music Volume"),
    ("BGM 包", "BGM Pack"),
    ("浏览创意工坊", "Browse Workshop"),
    ("创意工坊物品", "Workshop Items"),
    ("（无已订阅物品）", "(no subscribed items)"),
    ("已就绪", "Ready"),
    ("需更新（回车下载）", "Update needed (Enter)"),
    ("下载中 {pct}%", "Downloading {pct}%"),
    ("已订阅（等待下载）", "Subscribed (waiting)"),
    ("回车：下载/更新 · O：在工坊页打开 · R：刷新 · Esc/Q：返回", "Enter: download/update · O: open Workshop page · R: refresh · Esc/Q: back"),
    ("发布本地音效包", "Publish Local Pack"),
    ("发布本地包", "Publish Local Pack"),
    ("发布时复用物品 id", "Reuse Item on Publish"),
    ("要发布的包", "Pack to Publish"),
    ("自动（音效优先）", "Auto (SFX first)"),
    ("将发布：{name}", "Will publish: {name}"),
    ("无可发布的本地包", "No local pack to publish"),
    ("作者 {author} ｜ 音效 {n}/{total} ｜ BGM：{scenes}", "By {author} | SFX {n}/{total} | BGM: {scenes}"),
    ("发布可见性", "Publish Visibility"),
    ("复用（更新）", "Reuse (update)"),
    ("新建", "New item"),
    ("公开", "Public"),
    ("私有", "Private"),
    ("打开音频包目录", "Open Audio Folder"),
    ("试听当前音效包", "Audition SFX Pack"),
    ("试听 BGM 场景", "Audition BGM Scene"),
    ("生成示例包", "Generate Example Pack"),
    ("跟随场景", "Follow scene"),
    ("[生成]", "[Generate]"),
    ("菜单", "Menu"),
    ("大厅", "Lobby"),
    ...
    ("[发布]", "[Publish]"),
    ("创建中…", "Creating…"),
    ("需先在 Steam 同意 Workshop 协议", "Accept the Steam Workshop Legal Agreement first"),
    ("发布失败：通道断开", "Publish failed: channel closed"),
    ("Steam 不可用", "Steam unavailable"),
    ("需要 Steam", "Requires Steam"),
    ("已订阅 {n}（就绪 {ok}）", "{n} subscribed ({ok} ready)"),
    ("内置", "Built-in"),
    ("静音", "Mute"),
    ("语言", "Language"),
