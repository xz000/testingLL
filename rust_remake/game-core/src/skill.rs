...
impl DefTable {
    ...
    pub fn desc(id: SkillId) -> &'static str {
        use SkillId::*;
        match id {
            S000 => "直射火球，命中造成伤害与击退，并点燃周围造成持续伤害。",
            S001 => "召唤天罚轰击目标区域，造成范围伤害与击退。",
            S002 => "瞬发射线，命中造成伤害并击退；射程随等级提升。",
            S003 => "锁定点击处最近的敌人全速追击，命中造成伤害与击退。",
            S004 => "飞出后回旋拉回施法者，命中造成伤害与区域二次伤害。",
            S005 => "一段时间内张开护盾，将撞上的弹体与敌人反弹。",
            S006 => "在当前位置放置标记，再次施法回到标记处（两阶段）。",
            S007 => "一段时间内大幅提升移动速度并回复生命。",
            S008 => "直飞目标点后爆炸，造成范围伤害与击退。",
            S009 => "直射弹体，命中后分裂为多发造成范围伤害。",
            S010 => "短时间内大幅提升移动速度（隐身冲刺）。",
            S011 => "朝目标方向瞬移一段距离，可穿越障碍。",
            S012 => "直线冲锋，撞击敌人造成伤害与击退。",
            S013 => "与点选目标互换位置；无敌人则瞬移至点击处。",
            S014 => "持续吸取范围内敌人的生命以回复自身。",
            S015 => "朝前方持续喷射火焰，造成范围持续伤害。",
            S016 => "发射会弹跳的球体，多次命中造成伤害。",
            S017 => "将目标定身一段时间，使其无法行动。",
            S018 => "在目标区域产生引力场，吸引范围内单位并造成持续伤害。",
            S019 => "以锁链束缚敌人，造成伤害并限制其移动。",
            S022 => "制造镜像分身迷惑敌人。",
            S023 => "电弧（098b 独有；098c 名册无此技能，去留待定）。",
            _ => "（暂无描述）",
        }
    }
