...
| ~~**高·已完成**~~ | ~~技能定价（购买升级技能）~~ | ✅ **已实现（2026-09-10）**：对标 098c，`purchase_skill` 花钱购买 1 级、同树(槽)内互斥、整场锁定不可改（移除洗点/解绑）、买越多越贵（前 3 个基础价，第 4 个起单价 +`SPELL_COST_ESCALATION`=8）。`upgrade_skill` 升级已购技能。经济闭环闭合。 |
...
1. ~~**技能定价（购买升级技能）**~~：✅ **已完成**（2026-09-10，`purchase_skill` 对标 098c：花钱购买、同树互斥、整场锁定、买越多越贵）。
